...
"""Entry-point logic for the DGIWG GeoPackage validator (v1.59).
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog=textwrap.dedent("""\
            v1.59 fix: these examples used to invoke "dgiwg_validator.py",
            a filename that does not exist in the distribution. Use either the
            versioned launcher (DGIWG_Validator_v1_59.py) or the module form
            shown below.
            ...
            Examples:
              ...
              python DGIWG_Validator_v1_59.py --offline myfile.gpkg
        """),
    )
    parser.add_argument(
        "inputs",
