...
"""
DGIWG Validator v1.59 — Local Self-Test Harness (Anaconda Prompt)
=================================================================
...
The script:
  ...
  5. NEW IN v1.59 — regression tests for this release's changes:
       • version stamp is 1.59 in package, VERSION.txt, launcher, JSON schema
       ...
       • release assets (QUICKSTART.html, v1.59 manual, v1_59 launcher) exist
