...
No functional/behavioral changes to the validator itself. This release brings the project folder
back in sync after v1.62 shipped without its documentation being updated to match:
