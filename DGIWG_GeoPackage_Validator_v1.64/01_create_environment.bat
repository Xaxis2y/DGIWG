...
REM    4. Runs the 92-assertion self-test suite to confirm the install works
...
echo.
echo [4/5] Running the 92-assertion self-test suite ...
echo [4/5] Running the 92-assertion self-test suite ... >> "%LOG%"
...
if errorlevel 1 (
    ...
    echo   OK - all 92 assertions passed.
)
