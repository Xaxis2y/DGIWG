...
# DGIWG Table 9 — allowed CRS for raster tile pyramid (tiles data_type only)
# UTM zones are NOT in this list — they are only allowed for gridded/vector
...
MANUAL_GUIDANCE = {
    ...
    7: ("Verify each CRS code is on the DGIWG Table 9 approved list: 3395, 3857, 4326, 4979, 5041, 5042.",
